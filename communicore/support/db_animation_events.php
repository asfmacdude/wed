 ...
 * db_themes
 *
 * Database object for the animation events table
 *
 */
...
class db_animation_events extends db_common
{
	public $options;
	public $db;
	...
	public function setOptions($options)
	{
		...
		$this->options['TABLE_NAME']     = 'animation_events';
		$this->options['TABLE_ID_FIELD'] = 'aev_id';
	...
	{
		$fields = 'aev_id,aev_code';
		$order  = 'theme_name';
		$data   = $this->selectAllForList($fields,$order);	
		return (!$data) ? false : $data ;
	}
	
	public function loadEventCode($code=null)
	{
